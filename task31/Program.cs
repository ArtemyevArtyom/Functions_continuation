...
/*int getSumOfPositiveOrNegativesNumbersInArray(int[] incomingArray, int deviation)
{
    int result = 0;
    for (int i = 0; i < incomingArray.Length; i++)
    {
...
//sumOfPositive = getSumOfPositiveOrNegativesNumbersInArray(currentArray, 1);
//sumOfNegative = getSumOfPositiveOrNegativesNumbersInArray(currentArray, -1);
